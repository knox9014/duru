...
export const translations = {
  ko: {
    ...
    'update.available': '새 버전 {version} 이 나왔습니다. 받으러 갈까요?\n\n내려받기 쪽을 열어 드립니다. 받은 파일을 실행하면 설치됩니다.',
    'update.failed': '확인하지 못했습니다. 잠시 뒤 다시 시도하거나 홈페이지에서 직접 받아주세요.',
    'update.none': '최신 버전을 쓰고 있습니다',
    'update.checking': '업데이트 확인 중…',
    'settings.updateLabel': '시작할 때 새 버전 확인',
    'settings.updateDesc': '켜면 두루를 열 때 GitHub 에 최신 버전 번호만 한 번 물어봅니다. 문서는 절대 보내지 않습니다.',
  ...
  en: {
    ...
    'modal.get': 'Get it',
    'modal.later': 'Later',
    'update.available': 'Version {version} is out. Go get it?\n\nThis opens the download page. Run the file you get to install it.',
    'update.failed': "Couldn't check. Try again later, or download it from the website.",
    'update.none': "You're on the latest version",
    'update.checking': 'Checking for updates…',
    'settings.updateLabel': 'Check for new versions at startup',
    'settings.updateDesc': 'When on, duru asks GitHub once at startup for the latest version number. Your documents are never sent.',
